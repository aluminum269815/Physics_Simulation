...
class CannonballDetails(SettingWindow):
    ...
    def update_information(self):
        ...
        if cannonball:
            ...
            self.gravity_info.setText(f'{cannonball.gravity} m/s<sup>-2</sup>')
            self.air_resistance_enabled_info.setText('Yes' if cannonball.air_resistance_enabled else 'No')
            self.air_density_info.setText(f'{cannonball.air_density} kg/m<sup>-3<sup>' if cannonball.air_resistance_enabled else 'N/A')

            self.mass_info.setText(f'{cannonball.mass} kg')
            self.radius_info.setText(f'{cannonball.radius} m')
            self.firing_time_info.setText(f'{cannonball.firing_time} s')
            self.time_after_firing_info.setText(f'{cannonball.time_after_firing} s')

            self.initial_height_info.setText(f'{cannonball.initial_height} m')
            self.current_distance_info.setText(f'{cannonball.current_distance} m')
            self.current_height_info.setText(f'{cannonball.current_height} m')

            self.initial_total_velocity_info.setText(f'{cannonball.initial_total_velocity} m/s<sup>-1</sup>')
            self.initial_moving_direction_info.setText(f'{cannonball.initial_moving_direction} \u00B0')
            self.initial_horizontal_velocity_info.setText(f'{cannonball.initial_total_velocity} m/s<sup>-1</sup>')
            self.initial_vertical_velocity_info.setText(f'{cannonball.initial_total_velocity} m/s<sup>-1</sup>')

            self.current_total_velocity_info.setText(f'{cannonball.current_total_velocity} m/s<sup>-1</sup>')
            self.current_moving_direction_info.setText(f'{cannonball.current_moving_direction} \u00B0')
            self.current_horizontal_velocity_info.setText(f'{cannonball.current_horizontal_velocity} m/s<sup>-1</sup>')
            self.current_vertical_velocity_info.setText(f'{cannonball.current_vertical_velocity} m/s<sup>-1</sup>')

            self.current_total_acceleration_info.setText(f'{cannonball.current_total_acceleration} m/s<sup>-2</sup>')
            self.current_accelerating_direction_info.setText(f'{cannonball.current_accelerating_direction} \u00B0')
            self.current_horizontal_acceleration_info.setText(f'{cannonball.current_horizontal_acceleration} m/s<sup>-2</sup>')
            self.current_vertical_acceleration_info.setText(f'{cannonball.current_vertical_acceleration} m/s<sup>-2</sup>')

            self.initial_kinetic_energy_info.setText(f'{cannonball.initial_kinetic_energy} J')
            self.initial_gravitational_potential_energy_info.setText(f'{cannonball.initial_gravitational_potential_energy} J')
            self.initial_total_energy_info.setText(f'{cannonball.initial_total_energy} J')
            self.current_kinetic_energy_info.setText(f'{cannonball.current_kinetic_energy} J')
            self.current_gravitational_potential_energy_info.setText(f'{cannonball.current_gravitational_potential_energy} J')
            self.current_total_energy_info.setText(f'{cannonball.current_total_energy} J')
            self.energy_loss_info.setText(f'{cannonball.energy_loss} J')
